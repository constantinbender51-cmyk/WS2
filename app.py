...
# ==========================================
# 2. DATA PIPELINE (Focus on Last 5 Realities)
# ==========================================
def get_focused_data():
    ...
    # --- LOGIC: Filter for last 5 "Realities" ---
    # We define a 'reality' as a period ending when a new signal tree/regime starts.
    # We look for indices where the signal is not 0 (active regime)
    ...
    # Find the indices where the 'signal' changes to identify boundaries
    # We shift and compare to find where a new regime starts
    ...
    if len(change_indices) < 5:
        ...
        # Take the start index of the 5th-to-last reality
        start_idx = change_indices[-5]
        log(f"Focusing on the last 5 realities starting at index {start_idx}")
...
if __name__ == "__main__":
    log("==========================================")
    log(f" Starting Targeted Reality Training")
    log("==========================================")
