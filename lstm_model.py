...
def train_model():
    ...
    model = Sequential([
        LSTM(64, return_sequences=True, input_shape=(X_train_scaled.shape[1], 3), kernel_regularizer=l1_l2()),
        Dropout(0.3),
        LSTM(32, return_sequences=False, kernel_regularizer=l1_l2()),
        Dropout(0.3),
        Dense(8, activation='relu', kernel_regularizer=l1_l2()),
