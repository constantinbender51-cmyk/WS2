...
def train_model():
    ...
    model = Sequential([
        LSTM(32, return_sequences=True, input_shape=(X_train_scaled.shape[1], 3), kernel_regularizer=l1_l2(l1=4e-4, l2=1e-4)),
        Dropout(0.3),
        LSTM(16, return_sequences=False, kernel_regularizer=l1_l2(l1=4e-4, l2=1e-4)),
        Dropout(0.3),
